...
export class CatalogComponent {
  @Input() productos: Producto [] = [
    ...
    new ProductoClass(4, "Tentatenbalde Choco-frutilla", "Helado sabor chocolate y frutilla artesanal", 1200, "/assets/no_image_available.svg"),
    new ProductoClass(4, "Tentatenbalde frutilla-Americana", "Helado sabor frutilla y crema americana artesanal", 1200, "/assets/no_image_available.svg"),
    new ProductoClass(4, "Tentatenbalde D.Leche-Chocolate", "Helado sabor dulce de leche y chocolate artesanal", 1200, "/assets/no_image_available.svg")
  ];
}
