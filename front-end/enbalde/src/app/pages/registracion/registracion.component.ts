...
export class RegistracionComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.registrarForm = this.fb.group({
      ...
      mail: [this.usuarios.mail, [Validators.required, Validators.minLength(10), Validators.pattern("^[a-zA-Z0-9]+(.[_a-zA-Z0-9]+)@[a-z0-9-]+(.[a-z0-9-]+)(.[a-z]{2,15})$"), Validators.maxLength(45)]],
